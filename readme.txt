...
It may be necessary to start the game twice if it does not run at the first time (because some highscore file needs to be written)
...
----------------
==========================
2022-06-19:TuxFighter55.py
==========================
I got an email from Ingvar ingvar <step-ingwar@yandex.ru> who upgraded to Python3. I made some additional minimal corrections myself and updated on Github.
